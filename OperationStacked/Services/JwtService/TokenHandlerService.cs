...
namespace OperationStacked.Services.JwtService
{
    public class TokenHandlerService : ITokenHandlerService
    {
        ...
        public TokenHandlerService(IOptions<TokenOptions> tokenOptionsSnapshot, SigningConfigurations signingConfigurations, IPasswordHasherService passwordHasher)
        {
        ...
        public AccessToken CreateAccessToken(User userAccount)
        {
            ...
            var accessToken = BuildAccessToken(userAccount, refreshToken);
